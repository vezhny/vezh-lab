...
public class SelectRequestWirhPageArgumentsProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
        return Stream.of(
                ...
                Arguments.of(1, 4, "0", "", UserRequestStatus.OPEN.toString(), "", 1),
                Arguments.of(1, 4, "0", "", UserRequestStatus.IN_PROGRESS.toString(), "", 1),
                Arguments.of(1, 4, "0", "", UserRequestStatus.CLOSED.toString(), "", 1),
                Arguments.of(1, 4, "1", "", UserRequestStatus.OPEN.toString(), "", 2),
                Arguments.of(1, 4, "1", "", UserRequestStatus.IN_PROGRESS.toString(), "", 0),
                ...
                Arguments.of(1, 4, "2", "", UserRequestStatus.CLOSED.toString(), "", 0),
                Arguments.of(1, 4, "0", "", "", "Request", 3),
                Arguments.of(1, 4, "0", "", "", "Request data", 3),
                Arguments.of(1, 4, "0", "", "", "Request data 1", 1),
                Arguments.of(1, 4, "1", "", "", "Request data 1", 0),
                ...
                Arguments.of(1, 4, "0", "", UserRequestStatus.OPEN.toString(), "Request", 1),
                Arguments.of(1, 4, "0", "", UserRequestStatus.OPEN.toString(), "Request data", 1),
                Arguments.of(1, 4, "0", "", UserRequestStatus.OPEN.toString(), "Request data 1", 1),
                Arguments.of(1, 4, "0", "", UserRequestStatus.OPEN.toString(), "Request data 2", 0),
                Arguments.of(1, 4, "1", "", UserRequestStatus.OPEN.toString(), "Request", 2),
                Arguments.of(1, 4, "1", "", UserRequestStatus.OPEN.toString(), "Request data 2", 1),
                Arguments.of(1, 4, "1", "", UserRequestStatus.OPEN.toString(), "Request data 1", 0),
                Arguments.of(1, 4, "0", "", UserRequestStatus.IN_PROGRESS.toString(), "Request", 1),
                Arguments.of(1, 4, "0", "", UserRequestStatus.IN_PROGRESS.toString(), "Request data 1", 0),
                Arguments.of(1, 4, "0", "", UserRequestStatus.IN_PROGRESS.toString(), "Request data 4", 1),
                Arguments.of(1, 4, "1", "", UserRequestStatus.IN_PROGRESS.toString(), "Request", 0),
                Arguments.of(1, 4, "0", "", UserRequestStatus.CLOSED.toString(), "Request", 1),
                Arguments.of(1, 4, "0", "", UserRequestStatus.CLOSED.toString(), "Request data 5", 0),
                Arguments.of(1, 4, "0", "", UserRequestStatus.CLOSED.toString(), "Request data 6", 0),
                Arguments.of(1, 4, "0", "", UserRequestStatus.CLOSED.toString(), "Request data 7", 1),
                Arguments.of(1, 4, "1", "", UserRequestStatus.CLOSED.toString(), "Request data 8", 0)
        );
    }
}
