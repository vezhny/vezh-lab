...
public class EventDescriptions {
    ...
    public static final String USER_HAS_BEEN_BLOCKED = "User \"%s\" has been blocked";
    public static final String USER_HAS_BEEN_UNBLOCKED = "User \"%s\" has been unblocked";
    ...
    public static String userHasBeenBlocked(String login) {
        return format(USER_HAS_BEEN_BLOCKED, login);
    }

    public static String userHasBeenUnblocked(String login) {
        return format(USER_HAS_BEEN_UNBLOCKED, login);
    }
}
