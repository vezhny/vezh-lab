...
(
    ...
    PAN_POOL VARCHAR(100) NOT NULL,
    IMAGE_URL VARCHAR(250) NOT NULL
);
CREATE UNIQUE INDEX CARD_BRANDS_BRAND_ID_uindex ON CARD_BRANDS (BRAND_ID);
CREATE UNIQUE INDEX CARD_BRANDS_BRAND_NAME_uindex ON CARD_BRANDS (BRAND_NAME);
CREATE UNIQUE INDEX CARD_BRANDS_PAN_POOL_uindex ON CARD_BRANDS (PAN_POOL);
CREATE UNIQUE INDEX CARD_BRANDS_IMAGE_URL_uindex ON CARD_BRANDS (IMAGE_URL);