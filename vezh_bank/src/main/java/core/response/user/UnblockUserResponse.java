...
public class UnblockUserResponse implements VezhBankResponse {
    private Logger logger = Logger.getLogger(this.getClass());
    private ServiceProvider serviceProvider;
    private Map<String, String> requestParams;
    private UserRequestValidator userRequestValidator;

    public UnblockUserResponse(ServiceProvider serviceProvider, Map<String, String> requestParams) {
    ...
    public ResponseEntity build() {
        ...
        serviceProvider.getUserService().unblockUser(entity, serviceProvider.getEventService());
